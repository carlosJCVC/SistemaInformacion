...
/*     */ 
/*     */ public class PerdidasGanancias extends JDialog
/*     */ {
/*     */   Task tarea;
...
/*     */ 
/*     */   public PerdidasGanancias(Frame parent, boolean modal)
/*     */   {
...
/*  48 */     setTitle(bundle.getString("astPG"));
/*     */ 
/*  50 */     this.jPanel1.setBorder(BorderFactory.createEtchedBorder());
/*     */ 
/*  52 */     this.jButton1.setIcon(new ImageIcon(getClass().getResource("/contaes/iconos/MasientoPG.png")));
...
/*  57 */         PerdidasGanancias.this.jButton1ActionPerformed(evt);
/*     */       }
/*     */     });
...
/*     */     {
/* 128 */       setProgress(0);
/* 129 */       OperacionesCierre.perdidasGanancias();
/* 130 */       System.gc();
...
/* 141 */       PerdidasGanancias.this.jButton1.setEnabled(true);
/*     */     }
/*     */   }
/*     */ }

/* Location:           /media/sda1/contaes4/contaes4.jar
 * Qualified Name:     contaes.dialogosFunciones.PerdidasGanancias
